...
const AuthorCards = () => {
  return (
    <div className='px-[30px] py-[25px] border border-secondary rounded-[5px] w-full mx-auto lg:w-[270px] h-fit lg:h-[312px] relative group overflow-hidden'>
      ...
      <h1 className='font-semibold font-prompt text-[25px]'>Mateo Danienobi</h1>
     ...
     <Flex className={`flex-col w-full px-2 py-[30px] bg-white gap-9 md:w-[270px]`}>
       <Flex className={`items-center justify-between  gap-6`}>
        ...
        <FaFacebook className=' text-[28px] hover:text-main duration-100' />
       ...
       <Flex className={`items-center justify-between  gap-6`}>
        <Flex className={`items-center  gap-1`}>
        <FaTwitter className=' text-[28px] hover:text-main duration-100' />
       ...
       <Flex className={`items-center justify-between gap-6`}>
        <Flex className={`items-center gap-1 `}>
        <FaPinterest className=' text-[28px] hover:text-main duration-100' />
       ...
       <Flex className={`items-center justify-between  gap-6`}>
        <Flex className={`items-center  gap-1`}>
        <FaSquareInstagram className=' text-[28px] hover:text-main duration-100' />
